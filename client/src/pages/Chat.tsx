  ...
  const handleSend = (e: FormEvent) => {
    ...
    setTimeout(() => {
      const aiMessage: Message = {
        ...
        text: "I'm a simulated AI assistant for this demo. In a real application, I would analyze your financial data and provide personalized advice based on your query: \"" + userMessage.text + "\"",
        sender: 'ai'
      };
